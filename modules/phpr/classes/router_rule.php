...
class Phpr_Router_Rule
{
	...
	{
		$this->uri = $uri;
		$this->_params = Phpr_Router::get_uri_params(explode("/", $this->uri));
	}
	...
	public function controller($controller)
	{
		...
		if (Phpr_Router::value_is_param($controller))
		{
	...
	public function action($action)
	{
		...
		if (Phpr_Router::value_is_param($action))
		{
	...
	public function folder($folder)
	{
		...
		$path_params = Phpr_Router::get_uri_params(explode("/", $folder));
		foreach ($path_params as $param => $index)
		{
			if ($param != Phpr_Router::_url_controller && $param != Phpr_Router::_url_action && !isset($this->_params[$param]))
