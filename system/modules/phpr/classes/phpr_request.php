...
class Phpr_Request
{
    ...
    private $_cached_roozxt_url = null;
    ...
    {
        $request_param_name = Phpr::$config->get('REQUEST_PARAM_NAME', 'q');
        $backend_url = '/' . Phpr_Strings::normalize_uri(Phpr::$config->get('BACKEND_URL', 'admin'));
        $current_url = '/' . Phpr_Strings::normalize_uri(isset($_REQUEST[$request_param_name]) ? $_REQUEST[$request_param_name] : '');
    ...
    public function get_subdirectory()
    {
        ...
        $uri = $this->get_request_uri(); $path = $this->get_field($request_param_name);
    ...
    {
        Phpr::$deprecate->set_function('getSubdirectory', 'get_subdirectory');
        return $this->get_subdirectory();
    }

    public function getRootUrl()
    {
        Phpr::$deprecate->set_function('getRootUrl', 'get_root_url');
        return $this->get_root_url();
    }

    public function post()
    {
        Phpr::$deprecate->set_function('post', 'post_field');
